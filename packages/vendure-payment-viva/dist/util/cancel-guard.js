...
exports.shouldRefuseCancel = shouldRefuseCancel;
 ...
 */
function shouldRefuseCancel(rowStatus, paymentState) {
    if (!rowStatus || !exports.TERMINAL_STATUSES.has(rowStatus)) {
        return false;
    }
    // #26 carve-out: captured row + unsettled Payment = reconcilable desync.
    if (rowStatus === 'captured' && paymentState !== 'Settled') {
        return false;
    }
    return true;
}
