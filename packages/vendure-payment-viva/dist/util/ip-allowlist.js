...
exports.DEFAULT_VIVA_IP_ALLOWLIST = void 0;
 ...
 */
exports.DEFAULT_VIVA_IP_ALLOWLIST = [
    ...VIVA_PRODUCTION_IPS,
    ...VIVA_DEMO_IPS,
];
// ---------------------------------------------------------------------------
...
function isIpAllowed(sourceIp, allowlist) {
    ...
    const list = allowlist ?? exports.DEFAULT_VIVA_IP_ALLOWLIST;
 ...
 */
function getSourceIp(req, trustedProxyDepth = 0) {
    return (0, webhooks_1.extractClientIp)(req, trustedProxyDepth);
}
