...
let VivaShopApiResolver = class VivaShopApiResolver {
    ...
    // ---------------------------------------------------------------------------
    async orderByVivaReturn(vivaOrderCode, ctx) {
        if (!vivaOrderCode) {
            return null;
        }
        ...
        let payment;
        try {
            payment = await this.paymentService.findOneOrThrow(ctx, vivaRow.paymentId, ['order']);
        }
        catch {
            return null;
        }
...
__decorate([
    (0, graphql_1.Query)(),
    __param(0, (0, graphql_1.Args)('vivaOrderCode')),
    __param(1, (0, core_1.Ctx)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, core_1.RequestContext]),
    __metadata("design:returntype", Promise)
], VivaShopApiResolver.prototype, "orderByVivaReturn", null);
