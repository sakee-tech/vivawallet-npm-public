...
Mode is selected by VIVA_MODE (default: merchant; auto-isv if VIVA_RESELLER_* set):
  - ISV mode:      idempotently POSTs to /isv/v1/webhooks for every
                   ISV-registerable event type (1796, 1797, 1798, 8193, 8194).
                   4865 (Order Updated) is NOT ISV-registerable — per-merchant
                   Self-Care only.
