 ...
 */
const VIVA_PRODUCTION_IPS: string[] = [
  '51.138.37.238',
  '13.80.70.181',
  '13.80.71.223',
  '13.79.28.70',
 ...
 */
export const DEFAULT_VIVA_IP_ALLOWLIST: string[] = [
  ...VIVA_PRODUCTION_IPS,
  ...VIVA_DEMO_IPS,
];
...
function isInCidr(ip: string, cidr: string): boolean {
  ...
  if (prefixLen === 0) return true; // 0.0.0.0/0 = all
...
export function isIpAllowed(
  sourceIp: string,
  allowlist: string[] | false | undefined,
): boolean {
 ...
 */
export function getSourceIp(req: IncomingMessage, trustedProxyDepth = 0): string {
