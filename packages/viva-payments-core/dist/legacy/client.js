...
const index_js_3 = require("../observability/index.js");
// ---------------------------------------------------------------------------
// Constants
// ---------------------------------------------------------------------------
...
class BasicAuthClient {
    ...
    metrics;
    constructor(config) {
        this.legacyBaseUrl = index_js_1.LEGACY_HOST[config.environment];
        ...
        this.metrics = config.metrics ?? new index_js_3.NoopMetricsHook();
    ...
    async _executeWithRetry(opts) {
        ...
        while (true) {
            ...
            if (response.status === 401) {
                ...
                throw new index_js_2.VivaAuthError({
