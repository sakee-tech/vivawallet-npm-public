...
fixtures/
  ...
  webhooks/   — Viva webhook POST envelopes (EventTypeId 1796, 1797, 1798, 4865, 8193, 8194)
```
...
4. **Update `captured_at`** in each `_meta` block to today's date.

5. Run `pnpm -r test` to confirm all sandbox tests still pass.
