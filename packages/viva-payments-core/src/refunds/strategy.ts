 ...
 */
const FAST_REFUND_ELIGIBLE_SCHEMES: ReadonlySet<string> = new Set([
  'Visa',
  'MasterCard',
  'Maestro',
]);
...
export type RefundDecision =
  | { kind: 'fast'; reason: 'configured' | 'auto-eligible' }
  | {
      kind: 'standard';
      reason:
        | 'configured'
        | 'auto-ineligible-scheme'
        | 'auto-ineligible-card-present'
        | 'auto-no-card-info';
    };
 ...
 * @see references/payment-api.yaml:9268
 */
export function resolveRefundStrategy(
