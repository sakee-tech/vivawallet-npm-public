 ...
 */
import { StructuredJsonLogger, RedactingLogger, NoopTracerHook, } from '@sakeetech/viva-payments-core/observability';
 ...
 */
export function resetSharedMetrics() {
    _sharedMetrics = null;
}
// ---------------------------------------------------------------------------
// buildObservability
 ...
 */
export function buildObservability(_config) {
