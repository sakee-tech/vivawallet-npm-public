...
export const VIVA_PLUGIN_CONFIG_KEY = 'vivaPluginConfig';
 ...
 */
export function resolveVivaConfig(
  scope: ResolvableScope | undefined,
): VivaPluginConfig | undefined {
  if (!scope) return undefined;
  return scope.resolve<VivaPluginConfig>(VIVA_PLUGIN_CONFIG_KEY, {
