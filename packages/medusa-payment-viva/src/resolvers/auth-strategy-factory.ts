 ...
 */
export function buildAuthStrategies(config: VivaPluginConfig): AuthStrategySet {
  ...
  const resellerConfig =
    config.mode === 'isv' ? config.reseller : undefined;
  const reseller =
    resellerConfig !== undefined
